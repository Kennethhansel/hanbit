                ...
                <?php foreach ($series_list as $series): ?>
                    <div type="button" onclick="pilihSeries(this, '<?= htmlspecialchars($series['id']); ?>')"
                        ...
                        <div class="w-full h-24 flex items-center justify-center mb-4 bg-white">
                            <img src="<?= htmlspecialchars($series['foto']); ?>?v=<?= time(); ?>" alt="Foto <?= htmlspecialchars($series['nama']); ?>"
                                class="max-w-full max-h-full object-contain transition-all duration-200" onerror="this.src='images/series/default.png'">
                        </div>
